...
require_once("include/informe_intersup_cxc_old_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "informe_intersup_cxc_old" );
