...
{
	$value = "";
				if($table=="contractor_master" && $field=="contractor_decljur")
	{
		;
		return $value;
	}
				...
				if($table=="informe_intersup_oe_contratista" && $field=="evidencia")
	{
		...
		return $value;
				...
				if($table=="informe_intersup_oe_contratista" && $field=="evidencia_sup")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_anexos_contratista" && $field=="anexo_file")
	{
		...
		return $value;
				...
				if($table=="contractor_master_jur" && $field=="contractor_medicinapre_file")
	{
		;
		return $value;
	}
				if($table=="contractor_master_jur" && $field=="contractor_decljur")
	{
		;
		return $value;
	}
				...
				if($table=="contrato_attached" && $field=="att_file")
	{
		...
		return $value;
				...
				if($table=="global_documents" && $field=="doc_file")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_anexos_contratista_o" && $field=="anexo_file")
	{
		;
		return $value;
	}
...
function GetLWWhere($field, $ptype, $table = "")
{
		...
		if($table=="informe_intersup_oe_contratista" && $field=="sup_aprueba")
	{
		...
		if($table=="informe_intersup_4" && $field=="inf_estado")
	{
		$strWhere = " estadoi_id = 2";
		return $strWhere;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
				...
				if($table=="contractor_master" && $field=="sys_update")
	{
		return 1;
				...
				if($table=="contractor_master" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="contractor_master" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="contractor_master" && $field=="sys_level")
	{
		return 1;
	}
				if($table=="contractor_master" && $field=="sys_status")
	{
		return 1;
	}
				if($table=="contractor_master" && $field=="groupid")
	{
		return 1;
	}
				if($table=="contractor_master" && $field=="active")
	{
		return 1;
				...
				if($table=="contractor_master" && $field=="terms_msj")
	{
		return $_SESSION['GMsj'];
	}
				...
				if($table=="informe_intersup_anexos_contratista" && $field=="anexo_usuario")
	{
		return $_SESSION["UserID"];
				...
				if($table=="informe_intersup_anexos_contratista" && $field=="anexo_hash")
	{
		return TokenA(6);;
	}
				if($table=="informe_intersup_anexos_contratista" && $field=="anexo_grupo")
	{
		return 8;
	}
				if($table=="informe_intersup_4" && $field=="inf_estado")
	{
		return 2;
				...
				if($table=="contractor_master_jur" && $field=="contractor_city")
	{
		return 11001;
	}
				if($table=="contractor_master_jur" && $field=="sys_update")
	{
		return 1;
	}
				if($table=="contractor_master_jur" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="contractor_master_jur" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="contractor_master_jur" && $field=="sys_level")
	{
		return 1;
	}
				if($table=="contractor_master_jur" && $field=="sys_status")
	{
		return 1;
	}
				if($table=="contractor_master_jur" && $field=="groupid")
	{
		return 1;
	}
				if($table=="contractor_master_jur" && $field=="active")
	{
		return 1;
	}
				if($table=="informe_intersup_anexos_contratista_o" && $field=="anexo_usuario")
	{
		return $_SESSION["UserID"];
	}
				if($table=="informe_intersup_anexos_contratista_o" && $field=="anexo_hash")
	{
		return TokenA(8);;
	}
				if($table=="cert_master_1" && $field=="sol_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="informe_intersup_cxc_old" && $field=="de_pre")
	{
		return "PR";
	}
				if($table=="informe_intersup_cxc_old" && $field=="cxc_fechaelab")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="informe_intersup_cxc_old" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="informe_intersup_cxc_old" && $field=="sys_fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup_cxc_old" && $field=="sys_status")
	{
		return 0;
	}
	return "";
