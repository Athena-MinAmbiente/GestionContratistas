...
$dirnamea= "../GesDoc/Contratos/".$values['id_cont_fk']."/informes/".$values['inf_id_fk']."/anexos_informe/";
    if (is_dir($dirnamea)) {
    } else {
       mkdir("../GesDoc/Contratos/".$values['id_cont_fk']."/informes/".$values['inf_id_fk']."/anexos_informe/", 0777);
    }
...
for($i = 0; $i < count($fileArray); $i++)
{
  ...
  $newFileName = "../GesDoc/Contratos/".$values['id_cont_fk']."/informes/".$values['inf_id_fk']."/anexos_informe/".$values['inf_id_fk']."_".$values['id_cont_fk']."_".$values['ctrl']."_".$values['anexo_hash']."_".$i.".pdf";
