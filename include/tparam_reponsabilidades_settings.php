...
//$tdatatparam_reponsabilidades[".listAjax"] = false;
	...
	$tdatatparam_reponsabilidades[".audit"] = true;
...
$tdatatparam_reponsabilidades[".sqlHead"] = "SELECT r_id,  	codigo,  	responsabilidad";
...
$proto0["m_strFieldList"] = "r_id,  	codigo,  	responsabilidad";
