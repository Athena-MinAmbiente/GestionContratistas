...
$tdatatparam_ciiu[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdatatparam_ciiu[".originalPagesByType"] = $tdatatparam_ciiu[".pagesByType"];
$tdatatparam_ciiu[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdatatparam_ciiu[".originalPages"] = $tdatatparam_ciiu[".pages"];
$tdatatparam_ciiu[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"search\":\"search\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelstparam_ciiu["Spanish"]["Descripcion"] = "Descripcion";
	$fieldToolTipstparam_ciiu["Spanish"]["Descripcion"] = "";
	$placeHolderstparam_ciiu["Spanish"]["Descripcion"] = "";
...
$tdatatparam_ciiu[".googleLikeFields"][] = "Descripcion";
...
$tdatatparam_ciiu[".sqlHead"] = "SELECT Clase,  	Descripcion";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "tparam_ciiu";
	$fdata["Label"] = GetFieldLabel("tparam_ciiu","Descripcion");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdatatparam_ciiu["Descripcion"] = $fdata;
		$tdatatparam_ciiu[".searchableFields"][] = "Descripcion";
...
$proto0["m_strFieldList"] = "Clase,  	Descripcion";
