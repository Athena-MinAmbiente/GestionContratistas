...
class tDAL
{
	var $tbldbct_at_localhost__cert_master;
	...
	var $tbldbct_at_localhost__gestioncontratistas_audit;
	var $tbldbct_at_localhost__gestioncontratistas_uggroups;
	var $tbldbct_at_localhost__gestioncontratistas_ugmembers;
	var $tbldbct_at_localhost__gestioncontratistas_ugrights;
	...
	var $tbldbct_at_localhost__informe_intersup_planilla;
	...
	var $tbledl_at_127_0_0_1__tparam_gruposanguineo;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "cert_master", "varname" => "dbct_at_localhost__cert_master", "altvarname" => "cert_master", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "gestioncontratistas_audit", "varname" => "dbct_at_localhost__gestioncontratistas_audit", "altvarname" => "gestioncontratistas_audit", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		$this->lstTables[] = array("name" => "gestioncontratistas_uggroups", "varname" => "dbct_at_localhost__gestioncontratistas_uggroups", "altvarname" => "gestioncontratistas_uggroups", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		$this->lstTables[] = array("name" => "gestioncontratistas_ugmembers", "varname" => "dbct_at_localhost__gestioncontratistas_ugmembers", "altvarname" => "gestioncontratistas_ugmembers", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		$this->lstTables[] = array("name" => "gestioncontratistas_ugrights", "varname" => "dbct_at_localhost__gestioncontratistas_ugrights", "altvarname" => "gestioncontratistas_ugrights", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "informe_intersup_planilla", "varname" => "dbct_at_localhost__informe_intersup_planilla", "altvarname" => "informe_intersup_planilla", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "tparam_gruposanguineo", "varname" => "edl_at_127_0_0_1__tparam_gruposanguineo", "altvarname" => "tparam_gruposanguineo", "connId" => "edl_at_127_0_0_1", "schema" => "", "connName" => "dbedl at 127.0.0.1");
	}
