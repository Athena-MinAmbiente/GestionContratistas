 ...
 */
 ...
 class eventclass_informe_intersup_anexos_contratista_o  extends eventsBase
{
...
$dirnamea= "../GesDoc/Contratos/".$values['id_cont_fk']."/informes/".$values['inf_id_fk']."/anexos_obligatorios/";
    if (is_dir($dirnamea)) {
    } else {
       mkdir("../GesDoc/Contratos/".$values['id_cont_fk']."/informes/".$values['inf_id_fk']."/anexos_obligatorios/", 0777);
    }
...
for($i = 0; $i < count($fileArray); $i++)
{
  ...
  $newFileName = "../GesDoc/Contratos/".$values['id_cont_fk']."/informes/".$values['inf_id_fk']."/anexos_obligatorios/".$values['inf_id_fk']."_".$values['id_cont_fk']."_".$values['ctrl']."_".$values['anexo_hash']."_".$i.".pdf";
