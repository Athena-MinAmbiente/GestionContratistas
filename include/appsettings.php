...
$projectBuildKey = "1044_1713526509";
$wizardBuildKey = "41619";
$projectBuildNumber = "1044";
...
$tableCaptions["Spanish"]["cert_master_1"] = "Certificaciones";
$tableCaptions["Spanish"]["informe_intersup_cxc_old"] = "Informe Intersup Cxc Old";
$tableCaptions["Spanish"]["tparam_gruposanguineo"] = "Tparam Gruposanguineo";
$tableCaptions["Spanish"]["informe_intersup_planilla"] = "Planilla aportes";
...
$_SESSION['mailserver'] = $datos["mailserver"]; // servidor de correo @1213.com
$_SESSION['correosmtp'] = $datos["correosmtp"];// servidor de correo
...
$sqla = "SELECT global_msj.msj_text FROM global_msj WHERE global_msj.msj_id = 1";
$rsa = DB::Query($sqla);
$datosa = $rsa->fetchAssoc();
if($datosa)
	{
$_SESSION['GMsj'] = $datosa["msj_text"]; // Nombre de la entidad
