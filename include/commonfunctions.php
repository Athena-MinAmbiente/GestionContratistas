...
function checkTableName($shortTName )
{
	...
	if ("tparam_tipo_ct_arl" == $shortTName )
		return true;
	if ("tparam_genero" == $shortTName )
		return true;
	if ("tparam_discapacidad" == $shortTName )
		return true;
	...
	if ("interventor_periodos" == $shortTName )
		return true;
	if ("contractor_master_signature" == $shortTName )
		return true;
	if ("informe_intersup_estado" == $shortTName )
		return true;
	if ("contractor_master_chart_genero" == $shortTName )
		return true;
	if ("contractor_master_view" == $shortTName )
		return true;
	if ("contractor_master_chart_eps" == $shortTName )
		return true;
	if ("contractor_master_chart_fondopension" == $shortTName )
		return true;
	if ("dashboard" == $shortTName )
		return true;
	if ("informe_intersup_contratista" == $shortTName )
		return true;
	if ("informe_intersup_oe_contratista" == $shortTName )
		return true;
	if ("tparam_sn_oe" == $shortTName )
		return true;
	if ("informe_intersup_anexos_contratista" == $shortTName )
		return true;
	if ("informe_intersup_anexos_tipo" == $shortTName )
		return true;
	if ("global_users" == $shortTName )
		return true;
	if ("q_bandejaentrada_supervisores" == $shortTName )
		return true;
	if ("q_genera_informe" == $shortTName )
		return true;
	if ("nomina_cont_meses" == $shortTName )
		return true;
	if ("informe_intersup_4" == $shortTName )
		return true;
	if ("informe_intersup_plan_pagos" == $shortTName )
		return true;
	if ("q_inf_plandepagos" == $shortTName )
		return true;
	if ("q_info_cxc" == $shortTName )
		return true;
	if ("hoja_ruta_2020_tracking" == $shortTName )
		return true;
	if ("contractor_master_jur" == $shortTName )
		return true;
	...
	if ("contrato_attached_type" == $shortTName )
		return true;
	if ("global_documents" == $shortTName )
		return true;
	if ("informe_intersup_oe" == $shortTName )
		return true;
	if ("tparam_ciiu" == $shortTName )
		return true;
	if ("tparam_reponsabilidades" == $shortTName )
		return true;
	if ("tparam_tipopago" == $shortTName )
		return true;
	if ("tparam_naturaleza" == $shortTName )
		return true;
	if ("informe_intersup_anexos_contratista_o" == $shortTName )
		return true;
	...
	if ("admin_users" == $shortTName )
		return true;
	if ("cert_master_1" == $shortTName )
		return true;
	if ("informe_intersup_cxc_old" == $shortTName )
		return true;
	if ("tparam_gruposanguineo" == $shortTName )
		return true;
	if ("informe_intersup_planilla" == $shortTName )
		return true;
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tipo_regimen");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_genero");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_discapacidad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_genera_informe");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_genera_informe";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_4");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_4";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_inf_plandepagos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_inf_plandepagos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_cxc");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("hoja_ruta_2020_tracking");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="hoja_ruta_2020_tracking";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contractor_master_jur");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contractor_master_jur";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_documents");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="global_documents";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_ciiu");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_reponsabilidades");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_reponsabilidades";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_naturaleza");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_naturaleza";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_anexos_contratista_o");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_anexos_contratista_o";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cert_master_1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_cxc_old");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_cxc_old";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_gruposanguineo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_gruposanguineo";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_planilla");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_planilla";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
...
//	default permissions
	...
	if( $table=="contractor_master_jur" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="tparam_ciiu" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_reponsabilidades" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="tparam_naturaleza" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="informe_intersup_anexos_contratista_o" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="cert_master_1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="informe_intersup_cxc_old" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_gruposanguineo" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="informe_intersup_planilla" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
