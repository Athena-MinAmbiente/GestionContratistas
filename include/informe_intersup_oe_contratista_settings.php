...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelsinforme_intersup_oe_contratista["Spanish"]["anexo_sn"] = "Adjunta evidencia?";
	$fieldToolTipsinforme_intersup_oe_contratista["Spanish"]["anexo_sn"] = "";
	$placeHoldersinforme_intersup_oe_contratista["Spanish"]["anexo_sn"] = "";
...
$tdatainforme_intersup_oe_contratista[".addPageEvents"] = true;
...
$tdatainforme_intersup_oe_contratista[".googleLikeFields"][] = "anexo_sn";
...
$tdatainforme_intersup_oe_contratista[".orderindexes"] = array();
			$tdatainforme_intersup_oe_contratista[".orderindexes"][] = array(10, (1 ? "ASC" : "DESC"), "oe_ordinal");


$tdatainforme_intersup_oe_contratista[".sqlHead"] = "SELECT actividad,  cont_nit_contra_ta_fk,  evidencia,  evidencia_sup,  id_cont_fk,  inf_id_fk,  isoe_id,  oe,  oe_id_fk,  oe_ordinal,  sup_aprueba,  sup_fecha,  sup_obs,  sys_last_upd,  sys_user,  anexo_sn";
$tdatainforme_intersup_oe_contratista[".sqlFrom"] = "FROM informe_intersup_oe";
$tdatainforme_intersup_oe_contratista[".sqlWhereExpr"] = "(sup_aprueba in (0,1,3))";
...
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 16;
	$fdata["strName"] = "anexo_sn";
	$fdata["GoodName"] = "anexo_sn";
	$fdata["ownerTable"] = "informe_intersup_oe";
	$fdata["Label"] = GetFieldLabel("informe_intersup_oe_contratista","anexo_sn");
	$fdata["FieldType"] = 16;
		...
		$fdata["strField"] = "anexo_sn";

		$fdata["sourceSingle"] = "anexo_sn";

	
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "anexo_sn";
...
//end of Filters settings
	...
	$tdatainforme_intersup_oe_contratista["anexo_sn"] = $fdata;
		$tdatainforme_intersup_oe_contratista[".searchableFields"][] = "anexo_sn";
...
$proto0["m_strFieldList"] = "actividad,  cont_nit_contra_ta_fk,  evidencia,  evidencia_sup,  id_cont_fk,  inf_id_fk,  isoe_id,  oe,  oe_id_fk,  oe_ordinal,  sup_aprueba,  sup_fecha,  sup_obs,  sys_last_upd,  sys_user,  anexo_sn";
$proto0["m_strFrom"] = "FROM informe_intersup_oe";
$proto0["m_strWhere"] = "(sup_aprueba in (0,1,3))";
$proto0["m_strOrderBy"] = "ORDER BY oe_ordinal";
	
						;
			$proto0["cipherer"] = null;
$proto2=array();
$proto2["m_sql"] = "sup_aprueba in (0,1,3)";
...
$proto38["m_link"] = "SQLL_MAIN";
			$proto39=array();
$proto39["m_strName"] = "informe_intersup_oe";
$proto39["m_srcTableName"] = "informe_intersup_oe_contratista";
$proto39["m_columns"] = array();
$proto39["m_columns"][] = "isoe_id";
$proto39["m_columns"][] = "inf_id_fk";
$proto39["m_columns"][] = "oe_id_fk";
$proto39["m_columns"][] = "id_cont_fk";
$proto39["m_columns"][] = "cont_nit_contra_ta_fk";
$proto39["m_columns"][] = "oe_ordinal";
$proto39["m_columns"][] = "oe";
$proto39["m_columns"][] = "actividad";
$proto39["m_columns"][] = "anexo_sn";
$proto39["m_columns"][] = "evidencia";
$proto39["m_columns"][] = "evidencia_sup";
$proto39["m_columns"][] = "sup_aprueba";
$proto39["m_columns"][] = "sup_fecha";
$proto39["m_columns"][] = "sup_obs";
$proto39["m_columns"][] = "sys_last_upd";
$proto39["m_columns"][] = "sys_user";
$obj = new SQLTable($proto39);

$proto38["m_table"] = $obj;
$proto38["m_sql"] = "informe_intersup_oe";
$proto38["m_alias"] = "";
$proto38["m_srcTableName"] = "informe_intersup_oe_contratista";
$proto40=array();
$proto40["m_sql"] = "";
