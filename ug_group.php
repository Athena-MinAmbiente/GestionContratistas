...
$nonAdminTablesArr[] = "cert_master_1";
$nonAdminTablesArr[] = "informe_intersup_cxc_old";
$nonAdminTablesArr[] = "tparam_gruposanguineo";
$nonAdminTablesArr[] = "informe_intersup_planilla";
...
$wGroupTableName = $ug_connection->addTableWrappers( "gestioncontratistas_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "gestioncontratistas_ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "gestioncontratistas_ugrights" );
