...
function fillProjectEntites()
{
	...
	$projectEntities[ "cert_master_1" ] = array( "url" => "cert_master_1", "type" => 1 );
	$projectEntitiesReverse[ "cert_master_1" ] = "cert_master_1";
	$projectEntities[ "informe_intersup_cxc_old" ] = array( "url" => "informe_intersup_cxc_old", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup_cxc_old" ] = "informe_intersup_cxc_old";
	$projectEntities[ "tparam_gruposanguineo" ] = array( "url" => "tparam_gruposanguineo", "type" => 0 );
	$projectEntitiesReverse[ "tparam_gruposanguineo" ] = "tparam_gruposanguineo";
	$projectEntities[ "informe_intersup_planilla" ] = array( "url" => "informe_intersup_planilla", "type" => 0 );
	$projectEntitiesReverse[ "informe_intersup_planilla" ] = "informe_intersup_planilla";
