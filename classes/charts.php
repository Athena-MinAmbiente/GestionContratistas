...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("tipo_cta_banco" == $this->chrt_array['tables'][0])
			return true;
		if("tipo_regimen" == $this->chrt_array['tables'][0])
			return true;
		...
		if("tparam_tipo_ct_arl" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_genero" == $this->chrt_array['tables'][0])
			return true;
		...
		if("q_bandejaentrada_supervisores" == $this->chrt_array['tables'][0])
			return true;
		if("q_genera_informe" == $this->chrt_array['tables'][0])
			return true;
		...
		if("informe_intersup_plan_pagos" == $this->chrt_array['tables'][0])
			return true;
		if("q_inf_plandepagos" == $this->chrt_array['tables'][0])
			return true;
		if("q_info_cxc" == $this->chrt_array['tables'][0])
			return true;
		if("hoja_ruta_2020_tracking" == $this->chrt_array['tables'][0])
			return true;
		if("contractor_master" == $this->chrt_array['tables'][0])
			return true;
		...
		if("contrato_attached_type" == $this->chrt_array['tables'][0])
			return true;
		if("global_documents" == $this->chrt_array['tables'][0])
			return true;
		if("informe_intersup_oe" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_ciiu" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_reponsabilidades" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_tipopago" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_naturaleza" == $this->chrt_array['tables'][0])
			return true;
		if("informe_intersup_anexos" == $this->chrt_array['tables'][0])
			return true;
		if("q_001_dashboard" == $this->chrt_array['tables'][0])
			return true;
		if("gestioncontratistas_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("gestioncontratistas_ugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("contractor_master" == $this->chrt_array['tables'][0])
			return true;
		if("cert_master" == $this->chrt_array['tables'][0])
			return true;
		if("informe_intersup_cxc" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_gruposanguineo" == $this->chrt_array['tables'][0])
			return true;
		if("informe_intersup_planilla" == $this->chrt_array['tables'][0])
			return true;
